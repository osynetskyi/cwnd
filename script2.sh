...
plot "data/$1-$2.dat" using 1:2 title "$1-$2" with linespoints lt 1 pt 0, "data/$3-$4.dat" using 1:2 title "$3-$4" with linespoints lt 3 pt 0
__EOF
cp pics/result.png pics/$1-$2-vs-$3-$4.png
