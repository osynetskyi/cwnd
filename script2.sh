...
sed -rn "s/^Approx\.\sthroughput\s1\s(.*)\s(.*)$/\1 \2/p" cwnd.dat > data/2/tp-$1-$2.dat
sed -rn "s/^Approx\.\sthroughput\s2\s(.*)\s(.*)$/\1 \2/p" cwnd.dat > data/2/tp-$3-$4.dat
gnuplot<<__EOF
...
plot "data/2/tp-$1-$2.dat" using 1:2 title "$1-$2" with linespoints lt 1 pt 0, "data/2/tp-$3-$4.dat" using 1:2 title "$3-$4" with linespoints lt 3 pt 0
__EOF
cp pics/2/result.png pics/2/$1-$2-vs-$3-$4.png
cp pics/2/tp-result.png pics/2/tp-$1,$2-$3,$4-$5,$6.png
cp goodput.dat data/2/goodput-$1,$2-$3,$4-$5,$6.dat
