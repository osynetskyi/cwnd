...
sed -rn "s/^Approx\.\sthroughput\s1\s(.*)\s(.*)$/\1 \2/p" cwnd.dat > data/3/tp-$1-$2.dat
sed -rn "s/^Approx\.\sthroughput\s2\s(.*)\s(.*)$/\1 \2/p" cwnd.dat > data/3/tp-$3-$4.dat
sed -rn "s/^Approx\.\sthroughput\s3\s(.*)\s(.*)$/\1 \2/p" cwnd.dat > data/3/tp-$5-$6.dat
gnuplot<<__EOF
